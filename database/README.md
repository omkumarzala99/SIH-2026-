# Database Layer: PS-26009 MOIL Mining Intelligence Platform

Relational persistence layer built with SQLAlchemy 2.0.

## Supported Engines
1. **SQLite (Embedded Local)**: Default for instant development and hackathon presentation. Stores database at `data/processed/moil_mining.db`.
